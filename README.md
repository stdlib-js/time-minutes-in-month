...
```javascript
minutesInMonth = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/time-minutes-in-month@v0.0.9-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/time-minutes-in-month@v0.0.9-umd/browser.js"></script>
```
